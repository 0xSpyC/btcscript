pub mod Opcode {
    ...
    pub fn execute(opcode: u8, ref engine: Engine) {
        match opcode {
            ...
            166 => not_implemented(ref engine),
            167 => not_implemented(ref engine),
            168 => not_implemented(ref engine),
            169 => not_implemented(ref engine),
            170 => not_implemented(ref engine),
            171 => not_implemented(ref engine),
	...
	fn opcode_checksig(ref engine: Engine) {
		let mut pkBytes = engine.dstack.pop_byte_array();
